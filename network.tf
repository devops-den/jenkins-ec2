...
resource "aws_route_table" "jenkins-public-route-table" {
  vpc_id = aws_vpc.jenkins-vpc.id
  tags = {
...
resource "aws_route_table_association" "jenkins-public-route-1-association" {
...
resource "aws_route" "jenkins-public-internet-igw-route" {
  route_table_id         = aws_route_table.jenkins-public-route-table.id
